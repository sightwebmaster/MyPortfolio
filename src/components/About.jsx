        ...
        >
          ...
          <div className="mt-10 flex flex-wrap gap-5 justify-center">
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => window.open("https://www.linkedin.com/in/ben-chaaben-ahmed-2324a331a/", "_blank")}
            >
              LinkedIn
            </motion.button>
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => window.open("https://github.com/sightwebmaster", "_blank")}
            >
              GitHub
            </motion.button>
          </div>
        ...
        <motion.div variants={fadeIn("left", "spring", 0.5, 0.75)} className="w-full md:w-2/3">
          ...
          >
            <motion.li className="flex items-start" variants={fadeIn("up", "spring", 0.1, 0.75)}>
              ...
              <span>
                I&apos;m a Software Engineering student with a passion for crafting efficient and scalable solutions.
              </span>
            </motion.li>
            <motion.li className="flex items-start" variants={fadeIn("up", "spring", 0.2, 0.75)}>
              <span className="mr-4 text-2xl flex-shrink-0">🎓</span>
              <span>
                Currently studying computer science at National School of Engineering of Tunis (ENIT), I&apos;m an AI enthusiast.I am currently integrating AI in my software projects.
              </span>
            </motion.li>
            <motion.li className="flex items-start" variants={fadeIn("up", "spring", 0.3, 0.75)}>
              <span className="mr-4 text-2xl flex-shrink-0">🛠</span>
              <span>
                From Scratch to Deployment, I&apos;ve built end-to-end applications that solve real-world problems.
              </span>
            </motion.li>
